...
class BytecodeBlock(object):
    ...
    def get_jumpi_address(self):
        ...
        if jumpi_bytecode.opcode == "JUMPI" and isinstance(
    ...
    def get_function_signature(self):
        ...
        if (bytecode_1.opcode in {"PUSH4", "PUSH3"}
                and bytecode_2.opcode == "DUP2" and bytecode_3.opcode == "EQ"
                and isinstance(bytecode_4, PushByteCode)
                and bytecode_5.opcode == "JUMPI"):
        ...
        if (bytecode_0.opcode in {"PUSH4", "PUSH3"}
                and bytecode_1.opcode == "DUP2" and bytecode_2.opcode == "EQ"
                and bytecode_3.opcode == "ASSERT"):
    ...
    def insert_assert(self):
        jumpi_bytecode = self.__items[-1]
        assert_bytecode = ByteCode("ASSERT", "", jumpi_bytecode.get_address(),
                                   -1)
    ...
    def insert_intcall(self, opcode, caller_end):
        ...
        intcall_bytecode = ByteCode(opcode, "gg", exit_bytecode.get_address(),
                                    1)
        new_block.append(intcall_bytecode)
        push_bytecode = PushByteCode("PUSH1", "", exit_bytecode.get_address(),
                                     2)
    ...
    def insert_intreturn(self):
        ...
        intreturn_bytecode = ByteCode(INTERNAL_RETURN_OPCODE, "gg",
                                      bytecode_0.get_address())
