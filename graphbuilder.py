...
class GraphBuilder(Disassembler):
    ...
    def __build_graph(self, blocks):
        ...
        self.graph, self.tracker = interpreter.explore_control_flow_graph(
            0, Image(-1))
    ...
    def __create_fallback_function(self):
        if len(self.__signature_blocks) == 0:
            func = ExternalFunction(FALLBACK_SIGNATURE, self.graph,
                                    self.tracker, (0, None))
    ...
    def visualize_contract(self, out_file="temp/out_contract"):
